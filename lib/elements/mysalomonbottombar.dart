...
class MySalomonBottomBar extends StatelessWidget {
  ...
  final List<MySalomonBottomBarItem> items;
  ...
  /// The color of the background color when the item is selected.
            ...
            for (final item in items)
              TweenAnimationBuilder<double>(
                ...
                builder: (context, t, _) {
                  ...
                  final _selectedBackgroundColor =
...
/// A tab to display in a [MySalomonBottomBar]
class MySalomonBottomBarItem {
  /// An icon to display.
  final Widget icon;
